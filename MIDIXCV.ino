 ...
 *    
 *    Translates MIDI messages in multiple pitch control, gate, aftertouth, keyboard tracking etc. voltages.     
 *    Main board hardware built around an arduino nano and a quad,I2C 12-bit DAC (MCP4728).   
 *    Analog and digital boards hardware use a quad,I2C 12-bit DAC (MCP4728)
 *    
